...
#[tauri::command]
pub async fn get_items_by_id(id: i32) -> Result<Responses<Items>, Responses<String>> {
...
#[tauri::command]
pub async fn items_update(data: Items) -> Result<Responses<Items>, Responses<Items>> {
