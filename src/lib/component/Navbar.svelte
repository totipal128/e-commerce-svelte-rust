...
<nav class="bg-white/90 backdrop-blur-md h-16 shadow-sm border-b border-gray-100 sticky top-0 z-[50] flex items-center justify-between px-6">
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="h-10 w-10 rounded-full bg-gradient-to-br from-brand to-brand-strong border-2 border-white shadow-lg flex items-center justify-center text-white font-black text-base cursor-pointer hover:scale-105 transition-transform">
