<script>
  ...
  const headers = [
    ...
    { name: "Jenis Barang", value: "jenis_barang_name" },
    { name: "Satuan", value: "type_unit" },
    { name: "Jumlah", value: "qty_stock" },
    { name: "Harga Jual", value: "price_sell", type_data: "parseIDR" },
  ];
  // let data = [
...
<div class="w-full h-full">
  {#if loading}
    <div
      class="flex w-full h-[80vh] mt-3 rounded-2xl bg-white justify-center items-center"
    >
      <img
        src="/icon/gift/loading.gif"
        class="h-50 w-50 p-1 justify-center"
        alt="Tauri Logo"
      />
    </div>
  {:else}
